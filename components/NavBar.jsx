            ...
            <nav className="bg-slate-100 px-2 sm:px-4 py-2.5 sticky w-full z-20 top-0 left-0 border-b border-gray-200">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="flex md:order-2">
                        <a href='/cart' className="text-black hover:text-white hover:bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium relative rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0">
